...
void __fastcall KeyHooks::OnGameKeyDown(byte Key, byte Repeat)
{
	...
	if (Key == Blindz[1])
	{
		...
		InputConsole("Setting Blindspot - (ÿc0%dÿc4) [ÿc0%dÿc4,ÿc0%dÿc4]", Blindz[0], Blinds[0].at(Blindz[0]), Blinds[1].at(Blindz[0]));
		//Print(0, 4, "Setting Blindspot - (ÿc0%dÿc4) [ÿc0%dÿc4,ÿc0%dÿc4]", Blindz[0], Blinds[0].at(Blindz[0]), Blinds[1].at(Blindz[0]));
